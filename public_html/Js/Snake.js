...
/* here this is where my game is initialized*/
function gameInitialize() {
    ...
    startGame = document.getElementById('startScreen');
...
/* here is where I add the snake to go down at the start of the game*/
...
/* this is where i show the state of the game and when its initilized for playing*/
